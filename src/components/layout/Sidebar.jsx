...
import { Home, Tv, Film, Radio, Bookmark, Settings, PlayCircle, Heart, Book, Globe } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: <Globe size={22} />, label: 'TV Internasional', mobileLabel: 'Global', href: '/tv-inter' },

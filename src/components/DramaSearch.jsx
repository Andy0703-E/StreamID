...
const DramaSearch = () => {
    ...
    const handleSearch = async (value) => {
        ...
        searchTimeout.current = setTimeout(async () => {
            try {
                ...
                // The API might return an array or { data: [...] }
    ...
    return (
        <div className="drama-search-container">
                ...
                <div className="search-results-overlay">
                    ...
                    {loading ? (
                        <div className="search-loading">
                            ...
                            <p>Sedang menelusuri library Drama...</p>
                        </div>
                    ) : results.length > 0 ? (
                        ...
                        <div className="no-results">
                            <Search size={48} />
                            <p>Maaf, drama tidak ditemukan. Coba gunakan kata kunci lain.</p>
                        </div>
                    )}
                </div>
            )}
